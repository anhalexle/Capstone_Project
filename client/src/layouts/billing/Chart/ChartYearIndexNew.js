    ...
    datasets: [
      {
        ...
        data: data.map((data) =>
          data.ThisYear?.OffPeak ? data.ThisYear.OffPeak : 0
        ),
        borderColor: 'white',
        type: 'bar',
        stack: 'Stack 0',
      },
      {
        ...
        data: data.map((data) =>
          data.ThisYear?.Normal ? data.ThisYear.Normal : 0
        ),
        type: 'bar',
        stack: 'Stack 0',
      },
      {
        ...
        data: data.map((data) =>
          data.ThisYear?.Peak ? data.ThisYear.Peak : 0
        ),
        type: 'bar',
        stack: 'Stack 0',
      },
      {
        ...
        // data: data.chart.map((data) => (data.ThisYear?.offPeak ? data.ThisYear.offPeak : 0)),
        data: data.map((data) =>
          data.LastYear?.OffPeak ? data.LastYear.OffPeak : 0
        ),
        borderColor: 'white',
        type: 'bar',
        stack: 'Stack 1',
      },
      {
        ...
        // data: data.chart.map((data) => data.ThisYear.normal),
        data: data.map((data) =>
          data.LastYear?.Normal ? data.LastYear.Normal : 0
        ),
        type: 'bar',
        stack: 'Stack 1',
      },
      {
        ...
        // data: data.chart.map((data) => data.ThisYear.peak),
        data: data.map((data) =>
          data.LastYear?.Peak ? data.LastYear.Peak : 0
        ),
        type: 'bar',
        stack: 'Stack 1',
      },
